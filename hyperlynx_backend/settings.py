"""
Django settings for hyperlynx_backend project.
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-2e(78!op8$+lqzz5xw^5vas7h$-86!2^tqx&mfg&s#ujvn7o(^')
...
ROOT_URLCONF = 'hyperlynx_backend.urls'
...
WSGI_APPLICATION = 'hyperlynx_backend.wsgi.application'


# Database
# https://docs.djangoproject.com/en/6.0/ref/settings/#databases

# Use Railway's DATABASE_URL if available, otherwise fall back to Supabase config
